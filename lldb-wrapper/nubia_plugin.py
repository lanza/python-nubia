...
from nubia_context import lldbContext
from nubia_statusbar import lldbStatusBar
...
class lldbPlugin(PluginInterface):
    """
    ...
    def get_commands(self):
        return [
            AutoCommand(sample_commands.Target),

...
class Target:
    ...
    @command
    @argument("target_name", positional=True)
    def create(self, target_name: str):
        """
        print a name
        """
        cprint("target create {}".format(target_name))

    @command
    def list(self, stuff: int):
        """
        doing stuff
        """
        cprint("target list")
